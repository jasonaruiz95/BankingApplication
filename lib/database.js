...
function createTables() {
    ...
    sql = "CREATE PROCEDURE IF NOT EXISTS `change_user_with_username`(\n" +
                      "IN username VARCHAR(255),\n" +
                      "IN user_type_id INT\n" +
                  ")\n" +
                  "BEGIN\n" +
                    "UPDATE users u\n" +
                    "SET u.user_type_id = user_type_id \n" +
    ...
    function addDummyDataToDatabase() {
        ...
        sql = "CALL insert_user('test', 'test', 'customer', 'c9df8df29bea229f603a24f5674f061d763b188e41501949ef20a17af26659c7', '134397c672dd59da', @result)";
        con.query(sql, function(err,rows){
          if (err) {
            console.log(err.message);
            throw err;
          }
          console.log("database.js: Added 'Customer' to users");
        });

        sql = "CALL insert_account('Checking', 'customer')";
        con.query(sql, function(err,rows){
          if (err) {
            console.log(err.message);
            throw err;
          }
          console.log("database.js: Added 'Checking' account to customer");
        });

        sql = "CALL insert_account('Savings', 'customer')";
        con.query(sql, function(err,rows){
          if (err) {
            console.log(err.message);
            throw err;
          }
          console.log("database.js: Added 'Savings' account to customer");
        });
        ...
        sql = "CALL insert_user('employee', 'test', 'employee', 'c9df8df29bea229f603a24f5674f061d763b188e41501949ef20a17af26659c7', '134397c672dd59da', @result)";
        con.query(sql, function(err,rows){
          if (err) {
            console.log(err.message);
            throw err;
        ...
        sql = "CALL insert_account('Checking', 'employee')";
        con.query(sql, function(err,rows){
          if (err) {
            console.log(err.message);
            throw err;
          }
          console.log("database.js: Added 'Checking' account to employee");
        });

        sql = "CALL insert_account('Savings', 'employee')";
        con.query(sql, function(err,rows){
          if (err) {
            console.log(err.message);
            throw err;
          }
          console.log("database.js: Added 'Savings' account to employee");
        });

        sql = "CALL insert_user('admin', 'admin', 'admin', 'c9df8df29bea229f603a24f5674f061d763b188e41501949ef20a17af26659c7', '134397c672dd59da', @result)";
        con.query(sql, function(err,rows){
          if (err) {
            console.log(err.message);
            throw err;
        ...
        sql = "CALL insert_account('Checking', 'admin')";
        con.query(sql, function(err,rows){
          if (err) {
            console.log(err.message);
            throw err;
          }
          console.log("database.js: Added 'Checking' account to admin");
        });

        sql = "CALL insert_account('Savings', 'admin')";
        con.query(sql, function(err,rows){
          if (err) {
            console.log(err.message);
            throw err;
          }
          console.log("database.js: Added 'Savings' account to admin");
        });


        sql = "CALL change_user_with_username(?, ?)";
        con.query(sql, ["admin", 3], function(err,rows){
          if (err) {
            console.log(err.message);
            throw err;
          }
          console.log("database.js: elevated admin account to admin");
        });


        sql = "CALL change_user_with_username(?, ?)";
        con.query(sql, ["employee", 2], function(err,rows){
          if (err) {
            console.log(err.message);
            throw err;
          }
          console.log("database.js: elevated employee account to employee");
        });
